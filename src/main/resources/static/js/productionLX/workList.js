...
var WorkOrder_tbl = new Tabulator("#WorkOrder_tbl", {
	...
	columns: [
		...
		{ title: "지시수량", field: "workOrder_AllottedQty", headerHozAlign: "center", align:"right", width: 100, formatter:"money", formatterParams: {precision: false}},
		{ title: "생산수량", field: "workOrder_ProductionQty", headerHozAlign: "center", align:"right", width: 100, formatter:"money", formatterParams: {precision: false}},
