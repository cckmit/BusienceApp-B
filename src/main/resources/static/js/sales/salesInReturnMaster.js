var salesInReturnInsertTable = new Tabulator("#salesInReturnInsertTable", {
	...
	columns: [
		...
		{title:"입고일", field:"sales_Small_Create_Date", headerHozAlign:"center" },
	]
});
...
function SIRI_Search() {
	datas = {
		sales_Packing_Code: $('#PRODUCT_ITEM_CODE1').val()
	}
	
	salesInReturnInsertTable.setData("salesPackingRest/SIRI_Search", datas);
...
function SIRS_Search() {
	datas = {
		...
		Sales_InMat_Rcv_Clsfc: '207'
	}
	
	salesInReturnSearchTable.setData("salesInputRest/SIL_Search", datas);
