...
function MOL_Search() {
	...
	matOrderListTable.setData("matOrderRest/MOM_Search",datas)
	.then(function(){		
...
function MOLS_Search(order_lCus_No) {
	...
	matOrderListSubTable.setData("matOrderRest/MOL_Search",datas)
	.then(function(){
...
function MOLSS_Search(itemCode) {
	matOrderListStockTable.setData("matStockRest/matStockSelect", {ItemCode : itemCode});
}
/*
