...
function stockChangePrinter(jsonDatas)
{	
	...
	var printCode = ""
		...
		printCode += "^XA"
				...
				+"^FT120,68^A1,50,40^FD"+jsonDatas.s_ItemName+"^FS"
				+"^FT135,130^A1,35,25^FD"+jsonDatas.s_ItemCode+"^FS"
				+"^FT135,190^A1,35,25^FH^FD"+jsonDatas.s_Item_Standard_1+"^FS"
				+"^FT135,250^A1,35,25^FH^FD"+jsonDatas.s_Item_Standard_2+"^FS"
				+"^FT135,310^A1,35,25^FH^FD"+jsonDatas.s_Item_Material+"^FS"
				+"^FT360,310^A1,35,25^FH^FD"+jsonDatas.s_Item_Classfy_1_Name+"^FS"
				+"^FT135,370^A1,35,25^FH^FD"+jsonDatas.s_Item_Unit+"^FS"
				+"^FT480,165^A1,50,40^FD"+Number(jsonDatas.s_Qty)+"^FS"
				+"^XZ";
	selected_device.send(printCode, undefined, errorCallback);
}
