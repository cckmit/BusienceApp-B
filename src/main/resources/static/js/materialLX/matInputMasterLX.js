...
function MIL_Search(){
	...
	matInputListTable.setData("matInputLXRest/MIL_Search", datas)
}
...
function MIIL_Search(){
	...
	matInputItemViewTable.setData("matInputLXRest/MIOL_Search", datas)
}
...
function MICL_Search(){
	...
	matInputCustomerViewTable.setData("matInputLXRest/MIOL_Search", datas)
}
...
function MIDM_Search() {
	...
	matInputDeliveryListTable.setData("matInputLXRest/MIDM_Search", datas);
}
...
function MIDS_Search(clientCode) {
	...
	matInputDeliveryItemTable.setData("matInputLXRest/MIDS_Search", datas);
}
