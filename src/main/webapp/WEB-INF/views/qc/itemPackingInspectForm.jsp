		...
		<div class="main">
			...
			<tbody>
					<tr>
						...
						<td colspan="4"><input type="text" id="itemInspectLotNo" readonly></td>
						<td colspan="3">제품명</td>
						<td colspan="4"><input type="text" id="itemInspectItemName" readonly></td>
					</tr>
					<tr>
						<td colspan="3">생산일자/검사일자</td>
						<td colspan="4"><input type="text" id="itemPackingDate" readonly> / <input type="text" id="itemInspectDate" readonly></td>
						<td colspan="3">검사자</td>
						<td colspan="4">
					...
					<tr>
						...
						<td colspan="3">시료수</td>
						<td colspan="4"><input type="text" id="itemInspectQty">&nbsp;&nbsp;
