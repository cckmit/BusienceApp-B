	...
	<div class="main">
		...
		<div class="master-inspect">
			<div class="top-var">
				...
				<!-- 그리드 생성 장소 -->
			<div id="tempStorageTable" class="none"></div>
		...
		<div class="master-in">
			...
			<!-- 그리드 생성 장소 -->
			<div id="matInputInspection"><jsp:include page="../material/matInputInspectForm.jsp" /></div>
			<!-- 그리드 생성 장소 -->
		</div>
	   	<!-- matOrderList -->
	</div>
...
<!-- Javascript -->
<script src="/js/qc/iqcList.js?v=<%=System.currentTimeMillis() %>"></script>
