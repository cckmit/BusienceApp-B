		...
		<div class="master-in">
			<div class="top-var">
				...
				<div class="input-box">
					...
					<div>
						<span><strong>지시번호</strong></span>
						<input id="Sales_Order_mOrder_No" type="text">
						<span><strong>거래처코드</strong></span>
						<input id="Sales_InMat_Client_Code" class="Client_Code" type="text" disabled>
						<span><strong>거래처명</strong></span>
						<input id="Sales_InMat_Client_Name" class="Client_Name clearInput" type="text" autofocus onkeypress="javascript:if(event.keyCode==13) {customerPopup($(this).val(),'input','','out')}">
					</div>
				</div>
			</div>
				<!-- 그리드 생성 장소 -->
...
<!-- Javascript -->
<script src="/js/sales/salesOutputLX.js?v=<%=System.currentTimeMillis() %>"></script>