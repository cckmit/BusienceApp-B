...
<c:set var="contextPath" value="${pageContext.request.contextPath}"  />
	...
	<div class="soloView">
		...
		<div class="main">
			<div class="top-var">
				...
				<div class="input-button">
					<img src="/images/button/ADD.png" data-toggle="modal" data-target="#inputModal" onclick="insert()"/>
		...
		<!-- input Modal -->
	<div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="line-height: 17px;">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				    <img class="insert" src="/images/modal/inputHeader.jpg"
							alt="" style="width: 40%; height: auto;" loading="lazy"
							style="position: relative;">
					<img class="modify" src="/images/modal/updateDeleteHeader.jpg"
						alt="" style="width: 40%; height: auto;" loading="lazy"
						style="position: relative;">
				</div>
				<div class="modal-body">
					...
					<fieldset>
							...
							<fieldset>
								...
								<br> <br>
								<label class="col-sm-2 control-label" for="EQUIPMENT_WIDTH">&nbsp;&nbsp;설&nbsp;비&nbsp;&nbsp;(폭)</label>
								<div class="col-sm-3">
							...
							<fieldset>
								...
								<div class="col-sm-3">
									<select id="EQUIPMENT_STATUS" style="width: 80%; height: 25px;" OnKeyDown="nextFocus('insert_defect_USE_STATUS')"> 
								...
								<br> <br>
								<label class="col-sm-2 control-label" for="EQUIPMENT_MODEL_YEAR">&nbsp;&nbsp;설&nbsp;비&nbsp;연&nbsp;식</label>
								<div class="col-sm-3">
									<input type="text" id="EQUIPMENT_MODEL_YEAR" style="width: 80%; height: 25px;"
										OnKeyDown="nextFocus('EQUIPMENT_MANUFACTURER')">
								</div>
								<div class="col-sm-1"></div>
								<label class="col-sm-2 control-label"
									for="EQUIPMENT_USE_STATUS">&nbsp;&nbsp;사&nbsp;용&nbsp;유&nbsp;무</label>
								<div class="col-sm-3">
								...
								<div class="col-sm-3">
									<input type="text" id="EQUIPMENT_MANUFACTURER" style="width: 120%; height: 25px;"
										OnKeyDown="nextFocus('EQUIPMENT_STATUS')">
								</div>
								<div class="col-sm-1"></div>
								<label class="col-sm-2 control-label" for="EQUIPMENT_INFO_RMARK">&nbsp;&nbsp;비&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;고</label>
								<div class="col-sm-3">
									<input type="text" id="EQUIPMENT_INFO_RMARK" style="width: 130%; height: 25px;"
										onkeypress="javascript:if(event.keyCode==13) {$('.focusBtn').focus()}">
								</div>
							</fieldset>
							<br>
							<div class="insert">
								<button type="button" class="btn btn-primary focusBtn" data-toggle="modal" data-target="#insertYesNo">저장</button>
								<button type="button" class="btn btn-danger" data-dismiss="modal">취소</button>
							</div>
							<div class="modify">
								<button type="button" class="btn btn-primary focusBtn" data-toggle="modal" data-target="#modifyYesNo">수정</button>
