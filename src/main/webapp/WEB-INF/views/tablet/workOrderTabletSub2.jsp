...
<body>
	...
	<div class="row" style="margin: 5px;">
		...
		<div class="col-md-3" style="padding:10px; border:solid; font-size: 45px; text-align: center; background-color: rgb(82,153,217); border-radius: 5%; cursor: pointer" id="move" onclick="move1()">
	...
	<div class="row" style="margin: 5px;" id="ko">
		<div class="col-md-12">
			<div id="WorkOrder_tbl1" style="font-size: 18px;"></div>    
		</div>
	</div>
	...
	<script>
			function move1(){
				$("#div1 #front").removeClass("none");
				$("#div1 #end").addClass("none");
			}
	</script>
