<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div style="width:100%;height:80%; padding: 10px;">
		...
		%>
				<div style="width:25%;height:100%; float: left; border-right: solid;" id="m<%=jj%>t">
		...
		<script>
			...
			%>
					var m00<%=i%>_table = new Tabulator("#m00<%=i%>_table", {
					    ...
					    columns:[
					        {title:"작업지시번호", field:"workOrder_ONo",visible:false, headerSort:false},
					        { title: "제품이름", field: "defect_CODE", headerHozAlign: "center", width: 160 , headerSort:false},
					        { title: "생산", field: "workOrder_RQty", headerHozAlign: "center", width: 80, align: "right",
								formatter:"money", formatterParams: {precision: false}, headerSort:false
							},
							{ title: "불량", field: "defect_DQty", headerHozAlign: "center", width: 80, align: "right",
								formatter:"money", formatterParams: {precision: false}, headerSort:false
							},
							{ title: "작업시작일", field: "workOrder_StartTime", align: "right", headerHozAlign: "center",visible:false, headerSort:false},
							{ title: "검사일", field: "defect_TestTime", align: "right", headerHozAlign: "center", headerSort:false},
