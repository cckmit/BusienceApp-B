			...
			<div class="card border-dark h-100" id="<%=i+1%>_card">
			  <div class="card-header bg-transparent border-dark">
			  	<table style="width: 100%;">
			  		<tr>
			  			<td><h1><%=i+1%>호기</h1></td>
			  			<td class="time" style="text-align: right; font-size: 40px;"></td>
			  		</tr>
			  	</table>
			  </div>
			  <div class="card-body">
			  ...
			  <div class="card-footer bg-transparent border-dark"><h1 id="<%=i+1%>h">ON</h1></div>
			</div>
			...
			<div class="card border-dark h-100" id="<%=i+1%>_card">
			  <div class="card-header bg-transparent border-dark">
			  	...
			  	<table style="width: 100%;">
			  		<tr>
			  			<td><h1><%=i+1%>호기</h1></td>
			  			<td class="time" style="text-align: right; font-size: 40px;">0</td>
			  		</tr>
			  	</table>
			  </div>
			  <div class="card-body">
