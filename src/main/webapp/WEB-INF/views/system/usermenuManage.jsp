...
<body>
				...
				<div class="top-var">
					<div class="input-button" style="width: 100%">
						<img id="custom-btn-default" style="margin-right: 46%"
							src="${contextPath}/resources/assets/img/ADD.png" onclick="insertModal2()"/>
							
						<img id="custom-btn-default"
							src="${contextPath}/resources/assets/img/Delete.png" onclick="deleteModal()"/>	
					</div>
				</div>
	...
	<script src="${contextPath}/resources/js/system/usermenuManage.js"></script>
