	...
	<div class="top-var">
		...
		<div class="input-box">
			<div>
				...
				<input id="SORI_startDate" class="today" type="date"> 
				<span style="text-align: center"><strong>~</strong></span> 
				<input id="SORI_endDate" class="tomorrow" type="date">
			</div>
			<div>
				...
				<input id="Sales_OutMat_Client_Code1" class="Client_Code1" type="text" disabled>
				<span><strong>거래처명</strong></span>
				<input id="Sales_OutMat_Client_Name1" class="Client_Name1 clearInput" type="text" onkeypress="javascript:if(event.keyCode==13) {customerPopup($(this).val(),'input','1','out')}">
			</div>
		</div>
	</div>
