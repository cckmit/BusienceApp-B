		...
		<div class="sub">
			<div class="top-var">
				...
				<div class="input-button" style="height: 73.13px">
					<div>
						<span><strong>발주일 기준(미입고 데이터)</strong></span>
					</div>
					<div>
						<span style="background-color: green; color: white;">
						<strong>3개월 이상</strong></span>
						&nbsp;&nbsp;
						<span style="background-color: orange; color: white;">
						<strong>6개월 이상</strong></span>
					</div>
				</div>
				<!-- 버튼 -->
				<div class="input-box">
...
<!-- Javascript -->
<script src="/js/materialLX/matOrderListLX.js?v=<%=System.currentTimeMillis() %>"></script>
