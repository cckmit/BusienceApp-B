	...
	<div class="main">
		<div class="top-var">
			...
			<div class="input-button">
				...
				<img src="/images/button/Excel.png" onclick="excel_download(proMaskTable)"/>
			</div>
			<!-- 버튼 -->
			<div class="input-box">
		...
		<div id="proMaskTable"></div>
	</div>
	<!-- END MAIN -->
</div>
<!-- Javascript -->
<script src="/js/production/proMaskSum.js?v=<%=System.currentTimeMillis() %>"></script>