...
public class workOrderListRestController {
	...
	public List<WorkOrder_tbl> MI_Search1(HttpServletRequest request) throws org.json.simple.parser.ParseException, SQLException
	{
		...
		if(WorkOrder_Check.equals("N"))
		{
			...
			where = " where t1.WorkOrder_WorkStatus='"+CHILD_TBL_NO+"'"
					+ "and t1.WorkOrder_RegisterTime between '" + startDate + " 00:00:00' and '" + endDate + " 23:59:59'";
		}
		else if(WorkOrder_Check.equals("Y"))
		{
			...
			where = " where t1.WorkOrder_WorkStatus='"+CHILD_TBL_NO+"'"
					+ "and t1.WorkOrder_ReceiptTime between '" + startDate + " 00:00:00' and '" + endDate + " 23:59:59'";
		}
		...
		if(WorkOrder_Check.equals("Y") || WorkOrder_Check.equals("C"))
		{
			if((String) obj.get("order_flag") != null)
			{
				...
				where += "and t1.WorkOrder_ReceiptTime between '" + startDate + " 00:00:00' and '" + endDate + " 23:59:59' and t1.WorkOrder_WorkStatus<>'293' ";
	...
	public String OrderUpdate(HttpServletRequest request) throws org.json.simple.parser.ParseException, SQLException
	{
		...
		String sql = "update WorkOrder_tbl set WorkOrder_WorkStatus='292',WorkOrder_ReceiptTime=now(),WorkOrder_Worker='"+modifier+"'"
	...
	public String OrderUpdate2(HttpServletRequest request) throws org.json.simple.parser.ParseException, SQLException
	{
		String workOrder_ONo = request.getParameter("workOrder_ONo");
		...
		String sql = "update WorkOrder_tbl set WorkOrder_WorkStatus='291',WorkOrder_ReceiptTime=now(),WorkOrder_Worker='"+modifier+"'"
				+ " where workOrder_ONo='"+workOrder_ONo+"'";
		System.out.println(sql);
	...
	public List<StockMat_tbl> MI_Search2(HttpServletRequest request) throws SQLException
	{
		...
		String sql = "select t1.*,t2.* from StockMatLX_tbl t1 inner join PRODUCT_INFO_TBL t2 on t1.SM_Code = t2.PRODUCT_ITEM_CODE where SM_Code='"+workOrder_ItemCode+"'";
