...
public class ItemDto {
	...
	private String PRODUCT_INFO_SUB_STND_2; // 규격 서브2
	...
	private boolean PRODUCT_SUBSID_MATL_MGMT; // 부자재관리
	...
	private boolean PRODUCT_WRHSN_INSPC; // 입고검사
	private boolean PRODUCT_USE_STATUS; // 사용유무
