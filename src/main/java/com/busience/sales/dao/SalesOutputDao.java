...
public interface SalesOutputDao {
	...
	// salesOutMat insert
	public int salesOutMatInsertDao2(SalesOutMatDto salesOutMatDto);
	...
	// salesOutMat Item View
	public List<Sales_OutMat_tbl> salesOutMatCustomerViewDao(@Param("Sales_OutMat_Client_Code") String Sales_OutMat_Client_Code, @Param("Sales_OutMat_Send_Clsfc") String Sales_OutMat_Send_Clsfc, @Param("startDate") String startDate, @Param("endDate") String endDate);
