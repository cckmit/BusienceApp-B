...
public class defectMonitoringRestController {
	...
	public List<DefectPerformance> defect_view(HttpServletRequest request){
		...
		String sql = "SELECT \r\n"
				...
				+ "		t2.WorkOrder_PQty,\r\n"
				+ "		t2.WorkOrder_RQty,\r\n"
				+ "		SUM(IF(Defect_Code='D001',Defect_Qty,0)) D001,\r\n"
				+ "		SUM(IF(Defect_Code='D002',Defect_Qty,0)) D002,\r\n"
				+ "		SUM(IF(Defect_Code='D003',Defect_Qty,0)) D003,\r\n"
				+ "		SUM(IF(Defect_Code='D004',Defect_Qty,0)) D004,\r\n"
				+ "		SUM(IF(Defect_Code='D005',Defect_Qty,0)) D005,\r\n"
				+ "		SUM(IF(Defect_Code='D997',Defect_Qty,0)) D997,\r\n"
				+ "		date_format(Defect_Insert_Time,'%Y-%m-%d %H:%m') Defect_TestTime\r\n"
				+ "		,SUM(Defect_Qty)\r\n"
